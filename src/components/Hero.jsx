...
function Hero() {
  ...
  return (
    <VisibilitySensor
      ...
      minTopValue={300}
    >
      <div className="hero wrapper bg-[#081730] flex items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
        {/* left side */}
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          <span>Experience The</span>{" "}
          <span>
            <b>Best Qulaity Sound</b>
          </span>
          <span className="text-[15px] pt-[1rem] text-[#525D6E]">
